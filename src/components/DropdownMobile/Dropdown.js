                            ...
                            carfeature?.map((item) => (
                                <div key={item.id}>
                                    <div className={styles.check_item}>
                                        <label htmlFor={item.id} onClick={() => handleChange(item)} className={styles.dropdown_option}>
                                            {item?.name}
                                        </label>

                                        <input id={item.id} value={item.id} type="checkbox" onChange={handleCheckboxChange} />
                                    </div>
